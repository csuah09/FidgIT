...
struct AddMoodView: View {
    ...
    var body: some View {
        VStack(spacing: 30) {
            Text("New Diary Entry").font(.largeTitle)
            HStack {
                Button(action: {
                    ...
                    Image("happy").resizable().frame(width: 50, height: 50).foregroundColor(.green).background(happyIsSelected ? Color.green : Color.clear).clipShape(Circle())
                }
                ...
                Button(action: {
                    ...
                    Image("meh").resizable().frame(width: 50, height: 50).foregroundColor(.gray).background(mehIsSelected ? Color.gray : Color.clear).clipShape(Circle())
                }
                ...
                Button(action: {
                    ...
                    Image("sad").resizable().frame(width: 50, height: 50).foregroundColor(.red).background(sadIsSelected ? Color.red : Color.clear).clipShape(Circle())
                }
            }
            ...
            Button(action: {
                ...
                Text("Add Diary Entry").bold().frame(width: UIScreen.main.bounds.width - 30, height: 50).background(Color.blue).foregroundColor(.white).cornerRadius(10)
